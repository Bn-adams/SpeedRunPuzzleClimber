...
public class HUDManager : MonoBehaviour
{
    ...
    private void Update()
    {
        TimeSpan currentTime = TimeSpan.FromSeconds(timerManager.timeElapsed);

        timeText.text = $"{currentTime.Minutes:D2}:{currentTime.Seconds:D2}.{currentTime.Milliseconds / 10:D2}";
    }
